...
#
# Vendored into klipper-toolchange-stats from:
#   https://github.com/viesturz/klipper-toolchanger
#   (klipper/extras/tools_calibrate.py, branch main)
# Upstream license: GPLv3. This file retains its original license.
# Kept verbatim to ease syncing with upstream; do not refactor in place.
